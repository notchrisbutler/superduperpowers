...
for (const id of ['package-root', 'skills-dir', 'settings', 'skills-registration', 'required-skills', 'reviewer-agents', 'agent-registration', 'commands', 'tools', 'project-config', 'profile']) {
