...
name: code-reviewer
description: |
  Use this agent when a major project step, task group, or full implementation needs a full code-quality review against coding standards and maintainability expectations. Use lite-code-reviewer for small mechanical checkpoints.
model: inherit
---
