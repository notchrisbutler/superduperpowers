...
**Signal if uncomfortable pushing back out loud:** "I need to pause and verify this review feedback before applying it."
...
When responding to inline review comments on GitHub, respond in the comment thread (`gh api repos/{owner}/{repo}/pulls/{pr}/comments/{id}/replies`), not as a top-level PR comment.
